...
from ols_mcp.api import search_ontologies, get_ontology_details, get_ontology_terms
...
class TestOLSAPI(unittest.TestCase):
    ...
    def test_get_ontology_details(self, mock_get):
        ...
        mock_response.json.return_value = {
            ...
            "config": {
                "title": "Gene Ontology",
                "description": "The Gene Ontology project provides a controlled vocabulary to describe gene and gene product attributes",
                "version": "2024-01-01",
